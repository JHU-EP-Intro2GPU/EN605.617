...
<meta content="opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl · master · EN-605.417.31_FA16 / intro_to_gpu" property="og:title">
...
<meta content="http://absaroka.jhuep.com/EN-605.417.31_FA16/intro_to_gpu/blob/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl · master · EN-605.417.31_FA16 / intro_to_gpu" property="twitter:title">
...
<title>opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl · master · EN-605.417.31_FA16 / intro_to_gpu · GitLab</title>
...
<meta name="csrf-token" content="MiK0UNPQ7WEQc9Duw0hJ5g1XfRvuPSvEFv5sb4efaRV+ExfamNV89rR2PAEEGCTVFo6qyRT2CObplc3uvlYAAg==" />
...
<input type="hidden" name="path" id="path" value="opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl" />
<div class="dropdown">
...
<li>
<a href="/EN-605.417.31_FA16/intro_to_gpu/blob/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl"><strong>
GLinterop.cl
</strong>
</a></li>
</ul>
...
<a class="btn btn-sm" target="_blank" href="/EN-605.417.31_FA16/intro_to_gpu/raw/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl">Raw</a>
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/blame/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl">Blame</a>
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/commits/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl">History</a>
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/blob/18ea4946eebf9c9b710405b0848cb85613d7ac47/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl">Permalink</a>
</div>
<div class="btn-group" role="group">
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/edit/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl">Edit</a>
...
<div class="blob-content" data-blob-id="5e29e6b3fdacb54bc3e55811ee3301886d8d084d">
<pre class="code highlight"><code><span id="LC1" class="line"></span>
<span id="LC2" class="line"><span class="nv">__kernel</span> <span class="nv">void</span> <span class="nv">init_vbo_kernel</span><span class="p">(</span><span class="nv">__global</span> <span class="nv">float4</span> <span class="nv">*vbo,</span> <span class="nv">int</span> <span class="nv">w,</span> <span class="nv">int</span> <span class="nv">h,</span> <span class="nv">int</span> <span class="nv">seq</span><span class="p">)</span></span>
<span id="LC3" class="line"><span class="nv">{</span></span>
<span id="LC4" class="line">    <span class="nv">int</span> <span class="nv">gid</span> <span class="nb">=</span> <span class="nv">get_global_id</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span><span class="c1">;</span></span>
<span id="LC5" class="line">	<span class="nv">float4</span> <span class="nv">linepts</span><span class="c1">;</span></span>
<span id="LC6" class="line">	<span class="nb">float</span> <span class="nv">f</span> <span class="nb">=</span> <span class="nv">1.0f</span><span class="c1">;</span></span>
<span id="LC7" class="line">	<span class="nb">float</span> <span class="nv">a</span> <span class="nb">=</span> <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">h/4.0f</span><span class="c1">;</span></span>
<span id="LC8" class="line">	<span class="nb">float</span> <span class="nv">b</span> <span class="nb">=</span> <span class="nv">w/2.0f</span><span class="c1">;</span></span>
<span id="LC9" class="line"></span>
<span id="LC10" class="line">	<span class="nv">linepts.x</span> <span class="nb">=</span> <span class="nv">gid</span><span class="c1">;</span></span>
<span id="LC11" class="line">	<span class="nv">linepts.y</span> <span class="nb">=</span> <span class="nv">b</span> <span class="nb">+</span> <span class="nv">a*sin</span><span class="p">(</span><span class="nv">3.14*2.0*</span><span class="p">((</span><span class="nb">float</span><span class="p">)</span><span class="nv">gid/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w*f</span> <span class="nb">+</span> <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">seq/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w</span><span class="p">))</span><span class="c1">;</span></span>
<span id="LC12" class="line">	<span class="nv">linepts.z</span> <span class="nb">=</span> <span class="nv">gid+1.0f</span><span class="c1">;</span></span>
<span id="LC13" class="line">	<span class="nv">linepts.w</span> <span class="nb">=</span> <span class="nv">b</span> <span class="nb">+</span> <span class="nv">a*sin</span><span class="p">(</span><span class="nv">3.14*2.0*</span><span class="p">((</span><span class="nb">float</span><span class="p">)(</span><span class="nv">gid+1.0f</span><span class="p">)</span><span class="nb">/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w*f</span> <span class="nb">+</span> <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">seq/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w</span><span class="p">))</span><span class="c1">;</span></span>
<span id="LC14" class="line"></span>
<span id="LC15" class="line">	<span class="nv">vbo[gid]</span> <span class="nb">=</span> <span class="nv">linepts</span><span class="c1">;</span></span>
<span id="LC16" class="line"><span class="nv">}</span></span>
<span id="LC17" class="line"></span>
<span id="LC18" class="line"><span class="nv">__kernel</span> <span class="nv">void</span> <span class="nv">init_texture_kernel</span><span class="p">(</span><span class="nv">__write_only</span> <span class="nv">image2d_t</span> <span class="nv">im,</span> <span class="nv">int</span> <span class="nv">w,</span> <span class="nv">int</span> <span class="nv">h,</span> <span class="nv">int</span> <span class="nv">seq</span> <span class="p">)</span></span>
<span id="LC19" class="line"><span class="nv">{</span></span>
<span id="LC20" class="line">	<span class="nv">int2</span> <span class="nv">coord</span> <span class="nb">=</span> <span class="nv">{</span> <span class="nv">get_global_id</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span><span class="o">,</span> <span class="nv">get_global_id</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span> <span class="nv">}</span><span class="c1">;</span></span>
<span id="LC21" class="line">	<span class="nv">float4</span> <span class="nv">color</span> <span class="nb">=</span>  <span class="nv">{</span> </span>
<span id="LC22" class="line">					  <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">coord.x/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w,</span></span>
<span id="LC23" class="line">					  <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">coord.y/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">h,</span></span>
<span id="LC24" class="line">					  <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nb">abs</span><span class="p">(</span><span class="nv">seq-w</span><span class="p">)</span><span class="nb">/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w,</span></span>
<span id="LC25" class="line">					  <span class="nv">1.0f}</span><span class="c1">;</span></span>
<span id="LC26" class="line">	<span class="nv">write_imagef</span><span class="p">(</span> <span class="nv">im,</span> <span class="nv">coord,</span> <span class="nv">color</span> <span class="p">)</span><span class="c1">;</span></span>
<span id="LC27" class="line"><span class="nv">}</span></span></code></pre>
</div>
</div>
...
<h3 class="page-title">Delete GLinterop.cl</h3>
</div>
<div class="modal-body">
<form class="form-horizontal js-replace-blob-form js-quick-submit js-requires-input" action="/EN-605.417.31_FA16/intro_to_gpu/blob/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="9MTfKF+GhinuWubEOxK5B+dW0bl2a6YJbXIv8nmNQ9O49XyiFIMXvkpfCiv8QtQ0/I8Ga4yghSuSGY5zQEQqxA==" /><div class="form-group commit_message-group">
<label class="control-label" for="commit_message-6465ff27ed0f37cf9e7433f442099a7c">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-6465ff27ed0f37cf9e7433f442099a7c" class="form-control js-commit-message" placeholder="Delete GLinterop.cl" required="required" rows="3">
Delete GLinterop.cl</textarea>
</div>
</div>
</div>
...
<div class="checkbox">
<label for="create_merge_request-b348778e370aa9f998049ea79e769a4a"><input type="checkbox" name="create_merge_request" id="create_merge_request-b348778e370aa9f998049ea79e769a4a" value="1" class="js-create-merge-request" checked="checked" />
...
<div class="modal-header">
<a class="close" data-dismiss="modal" href="#">×</a>
<h3 class="page-title">Replace GLinterop.cl</h3>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form form-horizontal" action="/EN-605.417.31_FA16/intro_to_gpu/update/master/opencl-book-samples/src/Chapter_10/GLinterop/GLinterop.cl" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="46490zrf/YwBM4G21tl4o5d0INzkb/ESBh3DEHz5LlSvn55ZcdpsG6U2bVkRiRWQjK33Dh6k0jD5dmKRRTBHQw==" /><div class="dropzone">
...
<label class="control-label" for="commit_message-85676f3857148f3c8f531ccfe25ac8c7">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-85676f3857148f3c8f531ccfe25ac8c7" class="form-control js-commit-message" placeholder="Replace GLinterop.cl" required="required" rows="3">
Replace GLinterop.cl</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="checkbox">
<label for="create_merge_request-85e8bd2d82cbe7f55634fbfdbe014b79"><input type="checkbox" name="create_merge_request" id="create_merge_request-85e8bd2d82cbe7f55634fbfdbe014b79" value="1" class="js-create-merge-request" checked="checked" />
Start a <strong>new merge request</strong> with these changes
</label></div>
</div>
</div>
