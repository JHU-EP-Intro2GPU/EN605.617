...
<meta content="opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl · master · EN-605.417.31_FA16 / intro_to_gpu" property="og:title">
...
<meta content="http://absaroka.jhuep.com/EN-605.417.31_FA16/intro_to_gpu/blob/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl · master · EN-605.417.31_FA16 / intro_to_gpu" property="twitter:title">
...
<title>opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl · master · EN-605.417.31_FA16 / intro_to_gpu · GitLab</title>
...
<meta name="csrf-token" content="SgMgMLnRDa9scKXxyME2XznxDXiUUVU2reZkBwW7S8QGMoO68tScOMh1SR4PkVtsIijaqm6adhRSjcWGPHIi0w==" />
...
<input type="hidden" name="path" id="path" value="opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl" />
<div class="dropdown">
...
<li>
<a href="/EN-605.417.31_FA16/intro_to_gpu/blob/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl"><strong>
D3Dinterop.cl
</strong>
</a></li>
</ul>
...
<a class="btn btn-sm" target="_blank" href="/EN-605.417.31_FA16/intro_to_gpu/raw/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl">Raw</a>
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/blame/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl">Blame</a>
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/commits/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl">History</a>
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/blob/18ea4946eebf9c9b710405b0848cb85613d7ac47/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl">Permalink</a>
</div>
<div class="btn-group" role="group">
<a class="btn btn-sm" href="/EN-605.417.31_FA16/intro_to_gpu/edit/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl">Edit</a>
...
<div class="blob-content" data-blob-id="39591d0c4b576d4336629208fa06793587e32b43">
<pre class="code highlight"><code><span id="LC1" class="line"><span class="nv">__kernel</span> <span class="nv">void</span> <span class="nv">init_vbo_kernel</span><span class="p">(</span><span class="nv">__global</span> <span class="nv">float4</span> <span class="nv">*vbo,</span> <span class="nv">int</span> <span class="nv">w,</span> <span class="nv">int</span> <span class="nv">h,</span> <span class="nv">int</span> <span class="nv">seq</span><span class="p">)</span></span>
<span id="LC2" class="line"><span class="nv">{</span></span>
<span id="LC3" class="line">    <span class="nv">int</span> <span class="nv">gid</span> <span class="nb">=</span> <span class="nv">get_global_id</span><span class="p">(</span><span class="mi">0</span><span class="p">)</span><span class="c1">;</span></span>
<span id="LC4" class="line">	<span class="nv">float4</span> <span class="nv">linepts</span><span class="c1">;</span></span>
<span id="LC5" class="line">	<span class="nb">float</span> <span class="nv">f</span> <span class="nb">=</span> <span class="nv">1.0f</span><span class="c1">;</span></span>
<span id="LC6" class="line">	<span class="nb">float</span> <span class="nv">a</span> <span class="nb">=</span> <span class="nv">0.4f</span><span class="c1">;</span></span>
<span id="LC7" class="line">	<span class="nb">float</span> <span class="nv">b</span> <span class="nb">=</span> <span class="nv">0.0f</span><span class="c1">;</span></span>
<span id="LC8" class="line"></span>
<span id="LC9" class="line">	<span class="nv">linepts.x</span> <span class="nb">=</span> <span class="nv">gid/</span><span class="p">(</span><span class="nv">w/2.0f</span><span class="p">)</span><span class="nv">-1.0f</span><span class="c1">;</span></span>
<span id="LC10" class="line">	<span class="nv">linepts.y</span> <span class="nb">=</span> <span class="nv">b</span> <span class="nb">+</span> <span class="nv">a*sin</span><span class="p">(</span><span class="nv">3.14*2.0*</span><span class="p">((</span><span class="nb">float</span><span class="p">)</span><span class="nv">gid/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w*f</span> <span class="nb">+</span> <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">seq/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w</span><span class="p">))</span><span class="c1">;</span></span>
<span id="LC11" class="line">	<span class="nv">linepts.z</span> <span class="nb">=</span> <span class="nv">0.5f</span><span class="c1">;</span></span>
<span id="LC12" class="line">	<span class="nv">linepts.w</span> <span class="nb">=</span> <span class="nv">0.0f</span><span class="c1">;</span></span>
<span id="LC13" class="line"></span>
<span id="LC14" class="line">	<span class="nv">vbo[gid]</span> <span class="nb">=</span> <span class="nv">linepts</span><span class="c1">;</span></span>
<span id="LC15" class="line"><span class="nv">}</span></span>
<span id="LC16" class="line"></span>
<span id="LC17" class="line"><span class="nv">__kernel</span> <span class="nv">void</span> <span class="nv">xyz_init_texture_kernel</span><span class="p">(</span><span class="nv">__write_only</span> <span class="nv">image2d_t</span> <span class="nv">im,</span> <span class="nv">int</span> <span class="nv">w,</span> <span class="nv">int</span> <span class="nv">h,</span> <span class="nv">int</span> <span class="nv">seq</span> <span class="p">)</span></span>
<span id="LC18" class="line"><span class="nv">{</span></span>
...
<span id="LC20" class="line">	<span class="nv">float4</span> <span class="nv">color</span> <span class="nb">=</span>  <span class="nv">{</span> </span>
<span id="LC21" class="line">					  <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">coord.x/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w,</span></span>
<span id="LC22" class="line">					  <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">coord.y/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">h,</span></span>
<span id="LC23" class="line">					  <span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nb">abs</span><span class="p">(</span><span class="nv">seq-w</span><span class="p">)</span><span class="nb">/</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span><span class="nv">w,</span></span>
<span id="LC24" class="line">					  <span class="nv">1.0f}</span><span class="c1">;</span></span>
<span id="LC25" class="line">	<span class="nv">write_imagef</span><span class="p">(</span> <span class="nv">im,</span> <span class="nv">coord,</span> <span class="nv">color</span> <span class="p">)</span><span class="c1">;</span></span>
<span id="LC26" class="line"><span class="nv">}</span></span></code></pre>
</div>
</div>
...
<h3 class="page-title">Delete D3Dinterop.cl</h3>
</div>
<div class="modal-body">
<form class="form-horizontal js-replace-blob-form js-quick-submit js-requires-input" action="/EN-605.417.31_FA16/intro_to_gpu/blob/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="2NCDHoGvNunLbpMCbkJ4C423q3QRDaLOT/SnhXufq0uU4SCUyqqnfm9rf+2pEhU4lm58puvGgeywnwYEQlbCXA==" /><div class="form-group commit_message-group">
<label class="control-label" for="commit_message-0f4eaa14eb7e9c857f4e3e7f25e0c654">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-0f4eaa14eb7e9c857f4e3e7f25e0c654" class="form-control js-commit-message" placeholder="Delete D3Dinterop.cl" required="required" rows="3">
Delete D3Dinterop.cl</textarea>
</div>
</div>
</div>
...
<div class="checkbox">
<label for="create_merge_request-1802b091296abc2cdd53132c404ce203"><input type="checkbox" name="create_merge_request" id="create_merge_request-1802b091296abc2cdd53132c404ce203" value="1" class="js-create-merge-request" checked="checked" />
...
<div class="modal-header">
<a class="close" data-dismiss="modal" href="#">×</a>
<h3 class="page-title">Replace D3Dinterop.cl</h3>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form form-horizontal" action="/EN-605.417.31_FA16/intro_to_gpu/update/master/opencl-book-samples/src/Chapter_11/D3Dinterop/D3Dinterop.cl" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="vYO8W7XUVt5p40wtGeDN/1BXporbakCbfXoDQpjsHKnxsh/R/tHHSc3moMLesKDMS45xWCGhY7mCEaLDoSV1vg==" /><div class="dropzone">
...
<label class="control-label" for="commit_message-4d8f7f5a39f8c35e95a39137b55266dc">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-4d8f7f5a39f8c35e95a39137b55266dc" class="form-control js-commit-message" placeholder="Replace D3Dinterop.cl" required="required" rows="3">
Replace D3Dinterop.cl</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="checkbox">
<label for="create_merge_request-420a35e4bf3aa0a0c900de419a105d5a"><input type="checkbox" name="create_merge_request" id="create_merge_request-420a35e4bf3aa0a0c900de419a105d5a" value="1" class="js-create-merge-request" checked="checked" />
Start a <strong>new merge request</strong> with these changes
</label></div>
</div>
</div>
